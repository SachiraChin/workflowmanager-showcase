...
====================
1. Should version sync be limited to raw/unresolved source versions only,
   or include resolved versions as well?
<!--it will be everything. we will copy data from global workflow template / versions as is. nothing is ommited.-->
2. Should global templates be immutable once published, or should admin be
   allowed to delete or edit prior versions?
<!--they can be mutated, just by admin-->
